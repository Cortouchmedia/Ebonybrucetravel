    ...
    <div className="min-h-screen flex items-stretch bg-slate-50">
        ...
        <div className="relative z-10 w-full p-20 flex flex-col justify-between">
          ...
          <div className="max-w-md">
            <h2 className="text-5xl font-black text-white leading-tight mb-8 uppercase tracking-tighter">
              Welcome <br />
              <span className="text-[#1F93D0]">back home.</span> <br />
            </h2>
            <p className="text-xl text-white/70 font-medium leading-relaxed mb-12">
              Access your saved itineraries, travel credits, and exclusive member-only rates across the globe.
            </p>
            <div className="flex items-center space-x-6">
              ...
              <p className="text-sm font-black text-white uppercase tracking-widest">Premium Member Network</p>
            </div>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-24 overflow-y-auto">
        <div className="w-full max-w-md py-12">
          <div className="mb-12">
            <h2 className="text-4xl font-black text-[#002D5B] mb-3 uppercase tracking-tighter">Sign In</h2>
            <p className="text-lg text-slate-400 font-medium">Continue your premium travel journey.</p>
          </div>
          ...
          <form className="space-y-6" onSubmit={(e) => {
            ...
            <div className="flex items-center justify-between px-2">
              <label className="flex items-center space-x-3 cursor-pointer group">
                <input type="checkbox" className="w-5 h-5 rounded-lg accent-[#1F93D0] border-2 border-slate-300 shrink-0" />
                <span className="text-[11px] font-bold text-slate-500 group-hover:text-[#002D5B] transition-colors">Remember Me</span>
              </label>
              <button 
                type="button" 
                onClick={() => onNavigate(View.FORGOT_PASSWORD)}
                className="text-[11px] font-black uppercase text-[#1F93D0] hover:text-[#002D5B] transition-colors underline underline-offset-4"
              >
                Forgot Password?
              </button>
            </div>
          ...
          <div className="flex items-center space-x-4 my-10">
            ...
            <span className="text-[10px] font-black text-slate-300 uppercase tracking-[0.3em]">OR SIGN IN WITH</span>
            <div className="flex-grow h-px bg-slate-100"></div>
          </div>
