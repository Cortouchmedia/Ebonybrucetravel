...
const Chat: React.FC = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: 'model', text: 'Hi! I am your Ebony Bruce assistant. How can I help you with your travel plans today?' }
  ]);
        ...
        <div className="w-80 md:w-96 h-[500px] bg-white border-4 border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] flex flex-col mb-4">
          ...
          <div className="bg-black text-white p-4 flex justify-between items-center">
            <div className="flex items-center space-x-2">
              <div className="w-6 h-6 border-2 border-white flex items-center justify-center font-black text-[10px]">EB</div>
              <span className="font-black uppercase text-xs tracking-widest">Chat Assistant</span>
            </div>
      ...
      >
        {isOpen ? (
          ...
          <div className="flex flex-col items-center">
            <span className="font-black text-sm leading-none">CHAT</span>
          </div>
        )}
      </button>
    </div>
